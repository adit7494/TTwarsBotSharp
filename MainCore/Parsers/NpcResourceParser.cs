namespace MainCore.Parsers
{
    public static class NpcResourceParser
    {
        ...
        /// <summary>
        /// Checks if the page has an NPC merchant dialog.
        /// Works for both standard Travian and TTWars.
        /// </summary>
        public static bool HasNpcMerchant(HtmlDocument doc)
        {
            var npcMerchantDialog = doc.DocumentNode
                .Descendants("div")
                .FirstOrDefault(x => x.HasClass("npcMerchant"));
            return npcMerchantDialog is not null;
        }

        /// <summary>
        /// Gets the resource inputs for NPC exchange.
        /// Returns null if any input is not found.
        /// Works for both standard Travian and TTWars.
        /// </summary>
        public static List<HtmlNode>? GetResourceInputs(HtmlDocument doc)
        {
            var inputs = new List<HtmlNode>();
