namespace MainCore.Parsers
{
    public static class VillagePanelParser
    {
        ...
        /// <summary>
        /// Checks if the page has a village list panel.
        /// Works for both standard Travian and TTWars.
        /// </summary>
        public static bool HasVillagePanel(HtmlDocument doc)
        {
            var sidebarBoxVillagelist = doc.GetElementbyId("sidebarBoxVillagelist");
            return sidebarBoxVillagelist is not null;
        }

        /// <summary>
        /// Gets the number of villages in the list.
        /// Works for both standard Travian and TTWars.
        /// </summary>
        public static int GetVillageCount(HtmlDocument doc)
        {
            var sidebarBoxVillagelist = doc.GetElementbyId("sidebarBoxVillagelist");
