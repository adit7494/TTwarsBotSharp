...
namespace WPFUI.Views.Tabs
{
    ...
    public partial class AddAccountTab : AddAccountTabBase
    {
        public AddAccountTab()
        {
            ...
            // Initialize server type combo box
            ServerTypeComboBox.ItemsSource = Enum.GetValues(typeof(ServerType));
            ServerTypeComboBox.SelectedItem = ServerType.Travian;
            ...
            this.WhenActivated(d =>
            {
                ...
                this.Bind(ViewModel, vm => vm.AccountInput.ServerType, v => v.ServerTypeComboBox.SelectedItem).DisposeWith(d);
